          ...
          <div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:520px;margin:0 auto;background:#f7faf8;border-radius:18px;overflow:hidden;border:1px solid #ddeee5;">
            ...
            <div style="padding:32px 28px;">
              ...
              <div style="background:#d4ede1;border-radius:12px;padding:16px 18px;margin:20px 0;border-left:4px solid #2d7a52;">
                <p style="font-size:13px;color:#1e4d35;margin:0;line-height:1.6;">⏳ Votre compte est en attente de validation par l'administrateur.<br/>Vous recevrez un email dès que votre accès sera activé — généralement dans la journée !</p>
              </div>
              <p style="font-size:13px;color:#5a7a65;line-height:1.7;">En rejoignant Bassy Entraide, vous vous engagez à respecter la charte de bienveillance du réseau : entraide sincère, prix honnêtes et respect de chacun.</p>
            </div>
        ...
        html: `
          <div style="font-family:'Helvetica Neue',Arial,sans-serif;max-width:520px;margin:0 auto;background:#f7faf8;border-radius:18px;overflow:hidden;border:1px solid #ddeee5;">
            <div style="background:linear-gradient(135deg,#1a3a5c,#2b6cb0);padding:32px 28px;text-align:center;">
              ...
              <div style="font-size:12px;color:rgba(255,255,255,.7);margin-top:4px;">Bassy Entraide · Panneau Admin</div>
            </div>
            <div style="padding:32px 28px;">
              <p style="font-size:14px;color:#1a2e22;line-height:1.7;">Un nouveau membre souhaite rejoindre Bassy Entraide :</p>
              <div style="background:#fff;border-radius:12px;padding:16px 18px;margin:20px 0;border:1px solid #ddeee5;">
                <p style="margin:0 0 8px;font-size:13px;color:#3d5a46;"><strong>Nom :</strong> ${prenom} ${nom}</p>
                <p style="margin:0;font-size:13px;color:#3d5a46;"><strong>Email :</strong> ${email}</p>
              </div>
              <a href="https://www.bassy-entraide.fr" style="display:block;text-align:center;background:linear-gradient(135deg,#2d7a52,#1e4d35);color:#fff;padding:14px;border-radius:12px;text-decoration:none;font-weight:700;font-size:14px;">Valider le compte →</a>
            </div>
